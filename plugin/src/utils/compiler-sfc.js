...
function isReferenced(node, parent, grandparent) {
  switch (parent.type) {
    ...
    case 'ExportSpecifier':
      // @ts-expect-error
      if (
        grandparent === null || grandparent === void 0
          ? void 0
          : grandparent.source
      ) {
        return false
...
;(function (module, exports) {
  ;(function (root) {
    ...
    var invalidReferenceCodePoints = [
      ...
      64999, 65000, 65001, 65002, 65003, 65004, 65005, 65006, 65007, 65534,
...
function prefixIdentifiers(
  ...
  const plugins = [
    ...(isTS ? ['typescript'] : []),
    ...((babelOptions === null || babelOptions === void 0
      ? void 0
      : babelOptions.plugins) || []),
  ]
  const ast = parser$1.parseExpression(
    source,
    Object.assign(Object.assign({}, babelOptions), { plugins })
  )
...
function compileScript(sfc, options = { id: '' }) {
  ...
  return Object.assign(Object.assign({}, scriptSetup), {
    ...
    map: genSourceMap
      ...
      : undefined,
    scriptAst:
      scriptAst === null || scriptAst === void 0 ? void 0 : scriptAst.body,
    scriptSetupAst:
      scriptSetupAst === null || scriptSetupAst === void 0
        ? void 0
        : scriptSetupAst.body,
  })
}
...
function resolveTemplateUsageCheckString(sfc, isTS) {
  ...
  parseHTML(
    content,
    Object.assign(Object.assign({}, baseOptions), {
      start(tag, attrs) {
...
function urlToRequire(url, transformAssetUrlsOption = {}) {
  ...
  if (transformAssetUrlsOption.base) {
    ...
    if (firstChar === '.' || firstChar === '~') {
      ...
      return `"${host}${(
        path__default['default'].posix || path__default['default']
      ).join(basePath, uriParts.path + (uriParts.hash || ''))}"`
    }
  }
  if (
    ...
    return function (path, options, cb) {
      ...
      return promisify(cb, function (cb) {
        readPartials(path, options, function (err, partials) {
          var extend =
            requires.extend ||
            (requires.extend = require$$2__default['default']._extend)
